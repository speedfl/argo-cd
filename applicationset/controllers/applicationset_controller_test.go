...
func (r *rendererMock) RenderTemplateParams(tmpl *v1alpha1.ApplicationSetTemplate, syncPolicy *v1alpha1.ApplicationSetSyncPolicy, params map[string]interface{}, useGoTemplate bool) (*v1alpha1.Application, error) {
